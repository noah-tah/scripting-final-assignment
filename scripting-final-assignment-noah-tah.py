...
def jefferyPig():
	...
	print("Jeffery Pig looks at you and says, 'No, I'm not lying! I swear!'")

	print("There is a chance that Jeffery Pig is lying to you.")
